...
var = tk.IntVar()
var.set(1)
radio_entstehungsrechnung = tk.Radiobutton(root, text="Entstehungsrechnung", variable=var, value=1)
radio_entstehungsrechnung.pack(anchor=tk.W)
radio_verteilungsrechnung = tk.Radiobutton(root, text="Verteilungsrechnung", variable=var, value=2)
radio_verteilungsrechnung.pack(anchor=tk.W)
radio_verwendungsrechnung = tk.Radiobutton(root, text="Verwendungsrechnung", variable=var, value=3)
